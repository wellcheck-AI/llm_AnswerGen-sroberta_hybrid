            ...
            messages=[
                {
                    ...
                    "content": f"""
                        ...
                        질문이 여러 개일 경우, 유사한 질문은 묶어서 표현할 수 있으며, 실제로 나온 질문 수만큼 나열하세요. 질문과 연관된 정보나 상황은 요약해서 ()안에 질문과 함께 제공하세요.
                        ...
                        형식:
                        1. [첫 번째 질문] 
                        2. [두 번째 질문] (질문이 두 개 이상일 경우 각 질문을 개별 항목으로 나열합니다.)
                        ---
                        ...
                        출력:
                        1. 간헐적 단식 목표 달성 도움 여부 (한 달간 2~3인치 감량, 16시간 간헐적 단식 유지 중)
                        2. 하루 탄수화물 섭취 적정성 (밥 반공기, 샌드위치 반쪽)
                        ---
                        ...
                        출력:
                        1. 혈당측정기의 물에 대한 내구성 및 부착 기간
                        2. 혈당 측정 방식 (자동/수동 기록 필요 여부)
                        3. 식후 활동 적정 시간
                    """,
                },
                {
